...
def generate_dataset(dir_path, num_clients, num_classes, niid, balance, partition, dir_param):
    ...
    if check(config_path, train_path, test_path, num_clients, num_classes, niid, balance, partition, dir_param):
        return
    ...
    X, y, statistic = separate_data((dataset_image, dataset_label), num_clients, num_classes,
                                    niid, balance, partition, dir_param)
    train_data, test_data = split_data(X, y)
    save_file(config_path, train_path, test_path, train_data, test_data, num_clients, num_classes,
              statistic, niid, balance, partition, dir_param)
...
if __name__ == "__main__":
    ...
    generate_dataset(dir_path, num_clients, num_classes, niid, balance, partition, dir_param=alpha)
