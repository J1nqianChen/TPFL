...
class HookManager:
    def __init__(self, model: nn.Module, hook_fn: Optional[Union[str, Callable]] = None,
        ...
        if self.hook_fn is None:
            ...
            logging.info("No hook function provided. Using flatten_hook_fn.")
    ...
    def clear_hooks(self) -> None:
        ...
        logging.info(f"{num_handles} handles removed.")
    ...
    def register_hooks(self, hook_fn: Callable) -> None:
        ...
        logging.info(f"{new_num_handles - prev_num_handles} Hooks registered. Total hooks: {new_num_handles}")
